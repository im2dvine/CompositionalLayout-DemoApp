...
class HomeViewController: UIViewController {
    ...
    lazy var collectionViewLayout: UICollectionViewLayout = {
        ...
        let layout = UICollectionViewCompositionalLayout { [weak self] (sectionIndex, enviroment) ->
            ...
            switch sectionType {
            case .header:
                let itemSize = NSCollectionLayoutSize(widthDimension: .absolute(375), heightDimension: .absolute(125))
                
                let item = NSCollectionLayoutItem(layoutSize: itemSize)
                
                let groupSize = NSCollectionLayoutSize(widthDimension: .absolute(375), heightDimension: .fractionalHeight(1))
